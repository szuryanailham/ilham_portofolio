  ...
  return (
    <div id="Home" className="w-full py-12 text-center flex items-center flex-col">
      ...
      <p className="w-full max-w-3xl mx-auto mt-5 text-center font-normal text-base md:text-md font-fontTitle px-4 md:px-12 font-Trap leading-relaxed text-gray-300 ">
        I am a Junior Back End Developer focused on building modern and responsive web applications using JavaScript and Laravel.
        <br className="hidden md:block" />
        <br className="hidden md:block" />
        I have experience developing end-to-end applications with React on the frontend and Laravel ,Node.js with Express on the backend.
        <br className="hidden md:block" />
        <br className="hidden md:block" />
        Additionally, I’m proficient in managing data using MySQL, PostgreSQL, and MongoDB to ensure performance and scalability.
      </p>

      <a href="/cv/my-resume.pdf" download className=" mt-10 inline-flex items-center gap-2 px-6 py-3 border border-white rounded-xl text-white hover:bg-[#502499] hover:text-white transition-all duration-300">
