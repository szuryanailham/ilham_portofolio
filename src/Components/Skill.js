...
import { SiMongodb, SiExpress, SiNextdotjs, SiTypescript, SiPostgresql, SiLaravel } from "react-icons/si";
...
const Skill = () => {
  const skills = [
    ...
    { name: "Laravel", icon: <SiLaravel className="text-red-600" /> }, // 🔥 Laravel ditambahkan
  ];
